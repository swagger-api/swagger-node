...
var convert = function convert(file, apiDeclarations, options, cb) {
  if (file) {
    try {
    ...
    console.log('convert was called')

    var swagger2 = yaml.safeDump(swaggerConverter(resource, declarations));
